...
def source_catalog(ra, dec, box_width):
    # Get 2MASS, WISE, and Gaia sources
    gaia_cat, gaia_mag_cols, gaia_2mass, gaia_2mass_crossref, gaia_wise, gaia_wise_crossref = query_GAIA_ptsrc_catalog(ra, dec, box_width)
    twomass_cat, twomass_cols = query_2MASS_ptsrc_catalog(outra, outdec, box_width)
    wise_cat, wise_cols = query_WISE_ptsrc_catalog(outra, outdec, box_width, wise_catalog='allwise')
...
#     #
#     module_path = resource_filename('mirage', '')
