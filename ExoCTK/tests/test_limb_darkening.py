...
MODELGRID = mg.ModelGrid(os.environ['MODELGRID_DIR'])
...
def test_ldc_calculation_no_filter():
    ...
    ld_session.calculate(Teff=4500, logg=5, FeH=0, profile='quadratic')
    ld_session.calculate(Teff=4500, logg=5, FeH=0, profile='4-parameter')
